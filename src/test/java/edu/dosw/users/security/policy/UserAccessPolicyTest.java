...
/**
 * Comprehensive unit tests for UserAccessPolicy.
 *
...
class UserAccessPolicyTest {
     ...
     * Initializes a fresh UserAccessPolicy instance to ensure test isolation
    ...
    void testCanAccessOwnUser_AuthorizedCases(String principal, Long requestedId) {
        when(authentication.isAuthenticated()).thenReturn(true);
        when(authentication.getPrincipal()).thenReturn(principal);

        boolean canAccess = policy.canAccessOwnUser(requestedId, authentication);
    ...
    void testCanAccessOwnUser_DeniedCases(Long requestedId,
        ...
        boolean canAccess = policy.canAccessOwnUser(requestedId, authToUse);
